          ...
          <CCard className="mb-4">
            ...
            <CCardBody>
              <p className="text-medium-emphasis small">
                ...
                button dropdowns, but with the addition of boolean prop <code>split</code> for
              ...
              <p className="text-medium-emphasis small">
                ...
                normal button dropdowns. Those additional changes hold the caret centered in the
