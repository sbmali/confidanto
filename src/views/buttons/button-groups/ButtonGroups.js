        ...
        <CCol xs={12}>
          <CCard className="mb-4">
            ...
            <CCardBody>
              ...
              <p>
                Feel free to combine input groups with button groups in your toolbars. Similar to
                the example above, you’ll likely need some utilities through to space items
                correctly.
              </p>
              <DocsExample href="components/button-group#button-toolbar">
                <CButtonToolbar
          ...
          <CCard className="mb-4">
            ...
            <CCardBody>
              <p className="text-medium-emphasis small">
                ...
                <code>&lt;CButtonGroup&gt;</code> when you need dropdown menus combined with a
                series of buttons.
              </p>
